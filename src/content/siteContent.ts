...
const media = (path: string) => withBase(path);
    ...
    sources: [
      {
        ...
        gallery: [
          {
            src: media("/media/nicole-foto/nicole-01.jpg"),
          ...
          {
            src: media("/media/nicole-foto/nicole-02-new.jpg"),
          ...
          {
            src: media("/media/nicole-foto/nicole-04-new.jpg"),
          ...
          {
            src: media("/media/nicole-foto/nicole-02-var.jpg"),
      ...
      },
      {
        ...
        gallery: [
          {
            src: media("/media/wedding-photography/mugurel-01.jpg"),
            alt: "Wedding photography 01",
            label: "",
            href: "https://a-mugurel.wfolio.pro/wedding",
          },
          {
            src: media("/media/wedding-photography/mugurel-02-alt.jpg"),
            alt: "Wedding photography 02",
            label: "",
            href: "https://a-mugurel.wfolio.pro/wedding",
          },
          {
            src: media("/media/wedding-photography/mugurel-03-alt.jpg"),
            alt: "Wedding photography 03",
            label: "",
            href: "https://a-mugurel.wfolio.pro/wedding",
          },
          {
            src: media("/media/wedding-photography/mugurel-04.jpg"),
...
export const portfolioItems: PortfolioItem[] = [
  {
    id: "us-films-direct-one",
    title: "US Films I",
    category: "Wedding Films",
    year: "2025",
    thumbnail: media("/media/project-velocity.svg"),
    mediaType: "video",
    embedSrc: "https://video.usfilms.ro/clipuri/clip1.mp4",
    summary:
      "Primul wedding film din selecție, livrat direct din biblioteca video US Films.",
  ...
  },
  {
    ...
    category: "Wedding Films",
    year: "2025",
    thumbnail: media("/media/project-atlas.svg"),
    mediaType: "video",
    embedSrc: "https://vimeo.com/1107534018?share=copy&fl=sv&fe=ci",
    summary:
      "Al doilea wedding film din selecție, redat ca player complet direct în pagină.",
  ...
  },
  {
    ...
    category: "Wedding Films",
    year: "2025",
    thumbnail: media("/media/project-flux.svg"),
    mediaType: "video",
    embedSrc: "https://www.youtube.com/embed/FNToMcI6o5s?si=EtTPwXp1oUjmN6SE",
    summary:
      "Al treilea wedding film din selecție, cu sunet, controale și fullscreen.",
  ...
  },
  {
    ...
    summary:
      "Al patrulea wedding film din selecție, păstrând același comportament de player interactiv.",
  ...
  },
  {
    ...
    summary:
      "Al cincilea wedding film din selecție, păstrând același player interactiv direct în pagină.",
